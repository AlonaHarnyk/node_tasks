...
## Крок 5 - Здача домашнього завдання.

Зроби скріншоти виконання команд, які збережи в папку `assets`, яку слід створити в корені проєкта. Додай відповідні зображення у файл `README.md` (створи цей файл в корені проєкту).

## Критерії прийому

- Створено репозиторій з домашнім завданням (назва репозиторію довільна)
